...
@section('content')
    <div class="premium-container container-fluid">
        <div
            ...
            <a href="{{ route('admin.agents.create') }}" class="btn-gold-action shadow-none">
                                            ...
                                            <div class="d-flex align-items-center">
                                                @if ($user->avatar)
                                                    <img src="{{ asset('storage/' . $user->avatar) }}"
                                                        class="user-avatar-premium" alt="{{ $user->name }}">
                                                @else
                                        ...
                                        <td data-label="Actions" class="text-end">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 dropdown-menu-premium"
                                                    ...
                                                    <li>
                                                        <button class="dropdown-item dropdown-item-premium py-2"
                                                    ...
                                                    <li>
                                                        <form method="POST"
                                                            action="{{ route('admin.agents.destroy', $user) }}"
                                                            class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            editUserModal.addEventListener('show.bs.modal', function (event) {
                ...
                document.getElementById('editUserForm').action = '/admin/agents/' + userId;
            });
            ...
            changePasswordModal.addEventListener('show.bs.modal', function (event) {
                ...
                document.getElementById('changePasswordForm').action = '/admin/agents/' + userId +
                    '/update-password';
            });
        });
    </script>
