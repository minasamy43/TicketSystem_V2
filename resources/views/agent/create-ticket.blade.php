...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('agent.tickets.store') }}" enctype="multipart/form-data">
                    @csrf
    ...
    <script>
        ...
        document.querySelector('form[action="{{ route('agent.tickets.store') }}"]').addEventListener('submit', function () {
